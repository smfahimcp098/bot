module.exports = {
  ...
  onStart: async function ({ message, api, args, event }) {
    ...
    if (!promptText) {
      return message.reply(`😖 Please enter a text prompt\nExample: \n${global.GoatBot.config.prefix}sdxl a boy or,\n${global.GoatBot.config.prefix}sdxl a girl --ar 2:3`);
    }
    ...
    try {
      ...
      const team = `sdxl?prompt=${encodeURIComponent(prompt)}${world}`;
      const ok = "xyz";
