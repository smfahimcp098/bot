...
//     role: 0,
//     longDescription: {
//       en: 'Generate an image from text using flux journey.'
//     },
//     category: 'image',
//     guide: {
...
//     if (!promptText) {
//       return message.reply(`Please enter a text prompt\nExample: \n${global.GoatBot.config.prefix}fluxjourney a cat or,\n${global.GoatBot.config.prefix}fluxjourney a girl --ar 2:3`);
//     }
...
//       const team = `fluxjourney?prompt=${encodeURIComponent(prompt)}${world}`;
// 	  const o = "xyz";
...
module.exports = {
  config: {
    ...
    cooldowns: 5,
    role: 0,
    shortDescription: "Generate and select images using Flux Journey.",
  ...
  onStart: async function ({ message, args, api, event }) {
    try {
      ...
      const urls = [
        `http://smfahim.${ok}/fluxjourney/gen`,
        `http://smfahim.${ok}/fluxjourney/gen`,
        `http://smfahim.${ok}/fluxjourney/gen`,
        `http://smfahim.${ok}/fluxjourney/gen`
      ];
